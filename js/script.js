...
const nameShinobi = document.querySelector('.nameShinobi');
const clanShinobi = document.querySelector('.clanShinobi');
const rangShinobi = document.querySelector('.rangShinobi');
...
window.addEventListener('load' , showCards(shinobiWorld));
